...
from langfuse.api.resources.datasets.types.paginated_dataset_runs import PaginatedDatasetRuns
...
def cleanup_experiments():
    for dataset_name in DATASETS:
        try:
            runs_response: PaginatedDatasetRuns = langfuse.api.datasets.get_runs(dataset_name=dataset_name, limit=100)
